...
@section('container')
    <form class="user" action="/dashboard/users/{{ $user->username }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control  @error('username') is-invalid @enderror" id="usernameId" name="username"
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control  @error('email') is-invalid @enderror" id="emailId" name="email"
        ...
        <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <input type="password" class="form-control  @error('password') is-invalid @enderror" id="passwordId"
                    name="password">
                @error('password')
                    <div class="invalid-feedback"> {{ $message }}</div>
                @enderror
        ...
        <div class="modal-footer">
            <button class="btn btn-primary" type="submit">Update User <span data-feather="log-out"></span></button>
