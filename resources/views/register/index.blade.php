                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">SIMAKS</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="/register" method="POST">
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="password @error('password') is-invalid @enderror">Password</label>
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label @error('password') is-invalid @enderror" for="password_confirmation">Confirm Password</label>
                                <div class="input-group input-group-merge">
